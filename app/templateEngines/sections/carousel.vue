<template>
  <div class="section-widget relative w-full h-[540px] bg-[#f7f7fa]" widget-name="carousel">
    <!-- 轮播图内容 -->
    ...
    <div class="absolute bottom-4 left-1/2 transform -translate-x-1/2 flex space-x-2">
      <button
        ...
        :aria-label="t('9b1abe6e.37de11', { index: index + 1 })"
      />
    </div>
